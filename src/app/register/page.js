...
export default function RegisterPage() {
    ...
    const handleRegister = async (e) => {
        ...
        if (data.user) {
            ...
            setSuccess(true);
            const message = `Halo Admin, saya baru saja mendaftar di SmartKos.\n\nNama: ${name}\nEmail: ${email}\n\nMohon bantuannya untuk melakukan konfirmasi akun saya. Terima kasih!`;
            const waUrl = `https://wa.me/6281717594886?text=${encodeURIComponent(message)}`;
                ...
                <form onSubmit={handleRegister} className="bg-[#1e293b] border border-[#334155] rounded-2xl p-8 space-y-5">
                    ...
                    {success && (
                        <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-4 py-3 rounded-xl text-sm">
                            Registrasi berhasil! Mengalihkan Anda ke WhatsApp untuk konfirmasi...
                        </div>
                    )}
