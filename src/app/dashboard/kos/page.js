...
export default function KosPage() {
    ...
    const handleDelete = async (item) => {
        if (!confirm("Yakin ingin menghapus kos ini? Semua kamar dan data terkait juga akan dihapus.")) return;
    ...
    const columns = [
        ...
        { key: "alamat", label: "Alamat" },
        {
            ...
            label: "Jumlah Kamar",
            render: (val) => (
                <span className="px-2.5 py-1 rounded-lg bg-indigo-500/20 text-indigo-400 text-xs font-medium">
                    {val?.[0]?.count || 0} kamar
                </span>
            ),
        },
        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium hover:from-indigo-600 hover:to-purple-700 transition-all"
                >
            ...
            {/* Modal */}
            <Modal isOpen={showModal} onClose={closeModal} title={editItem ? "Edit Kos" : "Tambah Kos"}>
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full px-4 py-3 rounded-xl bg-[#0f172a] border border-[#334155] text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 rounded-xl bg-[#0f172a] border border-[#334155] text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
