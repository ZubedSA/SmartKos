...
export default function Sidebar({ items, title, user, onLogout }) {
    const pathname = usePathname();

    return (
        <aside
            className="hidden lg:flex fixed left-0 top-0 h-full w-64 bg-[#1e293b] border-r border-[#334155] z-50 flex-col"
        >
            {/* Logo */}
